namespace GTSysOne.Class.Slip
{
    public struct clsSlip_IMCost
    {
        ...
        public static object[] Value(int m_operation = 0
                                    ...
                                    , double m_average = 0.000
                                    , double m_lastpurchasecost = 0.000
                                    , string m_lastupdate = ""
                                    ...
                                    )
        {
            ...
            s_Value[14] = m_average;
            s_Value[15] = m_lastpurchasecost;
            s_Value[16] = m_lastupdate;
            s_Value[17] = m_NewPK;
            return s_Value;
        }
        #endregion
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMCost", System.Convert.ToInt32(s_Value[0]), 0);
        }
        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMCost", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMCost", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMCost", 0, 3);
        }
    }
}
