...
{
    public struct clsSlip_RentCreditCardDetails
    {
        #region Column
                                    ...
                                    )
        {
            ...
            s_Value[11] = m_doc_sourced_rent_id;
            s_Value[12] = m_name;
            s_Value[13] = m_card_type;
            s_Value[14] = m_card_no;
            s_Value[15] = m_expiry_date;
            s_Value[16] = m_id;
            return s_Value;
        }
        #endregion
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipRentCreditCardDetails", System.Convert.ToInt32(s_Value[0]), 0);
        }
        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipRentCreditCardDetails", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipRentCreditCardDetails", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipRentCreditCardDetails", 0, 3);
        }
    }
}
