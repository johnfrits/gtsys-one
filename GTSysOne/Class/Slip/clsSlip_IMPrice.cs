namespace GTSysOne.Class.Slip
{
    public struct clsSlip_IMPrice
    {
        ...
        public static object[] Value(int m_operation = 0
                                    ...
                                    , double m_pricebeforetax = 0.000
                                    , double m_priceaftertax = 0.000
                                    , string m_lastupdate = ""
                                    ...
                                    )
        {
            ...
            s_Value[14] = m_mas_sourced_pricelevel_id;
            s_Value[15] = m_pricebeforetax;
            s_Value[16] = m_priceaftertax;
            s_Value[17] = m_lastupdate;
            s_Value[18] = m_NewPK;
            return s_Value;
        }
        #endregion
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMPrice", System.Convert.ToInt32(s_Value[0]), 0);
        }
        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMPrice", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMPrice", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMPrice", 0, 3);
        }
    }
}
