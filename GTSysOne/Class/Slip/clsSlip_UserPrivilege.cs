...
{
    public struct clsSlip_UserPrivilege
    {
        #region Column
        static string[] Column = {   "operation" 
                                    ...
                                    ,"datecreate"
                                    ,"doc_sourced_user_privilege_id"
                                    ,"map_sourced_action_id"
                                    ,"granted"
                                    ,"NewPK"
                                 };
        #endregion
        ...
        public static object[] Value(int m_operation = 0
                                    ...
                                    , string m_datecreate = ""
                                    , string m_doc_sourced_user_privilege_id = ""
                                    , int m_map_sourced_action_id = 0
                                    ...
                                    )
        {
            ...
            s_Value[12] = m_doc_sourced_user_privilege_id;
            s_Value[13] = m_map_sourced_action_id;
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipUserPrivilege", System.Convert.ToInt32(s_Value[0]), 0);
        }
        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipUserPrivilege", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipUserPrivilege", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipUserPrivilege", 0, 3);
        }
    }
}
