namespace GTSysOne.Class.Slip
{
    public struct clsSlip_IMLot
    {
                                    ...
                                    )
        {
            ...
            s_Value[17] = m_barcode;
            s_Value[18] = m_lotnumber;
            s_Value[19] = m_expirydate;
            s_Value[20] = m_qty;
            s_Value[21] = m_price;
            s_Value[22] = m_seq;
            s_Value[23] = m_NewPK;
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMLot", System.Convert.ToInt32(s_Value[0]), 0);
        }
        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMLot", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMLot", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipIMLot", 0, 3);
        }
    }
}
