...
{
    public struct clsSlip_EstablishmentSettings
    {
        #region Column
        static string[] Column = {   "operation" 
                                    ...
                                    ,"map_sourced_establishment_status_id"
                                    ,"mas_sourced_group_id"
                                    ,"doc_sourced_country_id"
                                    ,"mas_sourced_region_id"
                                    ,"mas_sourced_taxarea_id"
                                    ,"mas_sourced_allocationpattern_id"
        ...
        public static object[] Value(int m_operation = 0
                                    ...
                                    , string m_map_sourced_establishment_status_id = ""
                                    , string m_mas_sourced_group_id = ""
                                    , string m_doc_sourced_country_id = ""
                                    , string m_mas_sourced_region_id = ""
                                    , string m_mas_sourced_taxarea_id = ""
                                    , string m_mas_sourced_allocationpattern_id = ""
                                    ...
                                    )
        {
            ...
            s_Value[12] = m_area;
            s_Value[13] = m_mas_sourced_establishment_id;
            s_Value[14] = m_map_sourced_establishment_status_id;
            s_Value[15] = m_mas_sourced_group_id;
            s_Value[16] = m_doc_sourced_country_id;
            s_Value[17] = m_mas_sourced_region_id;
            s_Value[18] = m_mas_sourced_taxarea_id;
            s_Value[19] = m_mas_sourced_allocationpattern_id;
            s_Value[20] = m_mas_sourced_pricelevel_id;
            s_Value[21] = m_active;
            s_Value[22] = m_NewPK;
            return s_Value;
        }
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipEstablishmentSettings", System.Convert.ToInt32(s_Value[0]), 0);
        }
        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipEstablishmentSettings", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipEstablishmentSettings", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_SlipEstablishmentSettings", 0, 3);
        }
    }
}
