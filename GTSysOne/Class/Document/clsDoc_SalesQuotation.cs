...
namespace GTSysOne.Class.Document
{
    ...
    public struct clsDoc_SalesQuotation
    {
        #region Column
        ...
        public static object[] Value(int m_operation = 0
                                    ...
                                    , string m_datecreate = ""
                                    , string m_doc_source_customer_id = ""
                                    , string m_customer_name = ""
                                    , string m_posting_date = ""
                                    , string m_document_date = ""
                                    , string m_status = ""
                                    , double m_total_amount_incl_vat = 0.0
                                    ...
                                    )
        {
            ...
            s_Value[13] = m_doc_source_customer_id;
            s_Value[14] = m_customer_name;
            s_Value[15] = m_posting_date;
            s_Value[16] = m_document_date;
            s_Value[17] = m_status;
            s_Value[18] = m_total_amount_incl_vat;
            s_Value[19] = m_NewPK;
            return s_Value;
        }
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_DocSalesQuotation", System.Convert.ToInt32(s_Value[0]), 0);
        }

        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_DocSalesQuotation", 0, 1);
        }

        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_DocSalesQuotation", 0, 2);
        }

        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_DocSalesQuotation", 0, 3);
        }
    }
}
