namespace GTSysOne.Class.MasterFile
{
    public struct clsMas_MiscCode
    {
        ...
        public static object[] Value(int m_operation = 0
                                    ...
                                    , string m_datecreate = ""
                                    , string m_mas_sourced_itemaster_id = ""
                                    ...
                                    )
        {
            ...
            s_Value[12] = m_mas_sourced_itemaster_id;
            s_Value[13] = m_mas_sourced_group_id;
            s_Value[14] = m_code;
            s_Value[15] = m_NewPK;
            return s_Value;
        }
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasMiscCode", System.Convert.ToInt32(s_Value[0]), 0);
        }
        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasMiscCode", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasMiscCode", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasMiscCode", 0, 3);
        }
    }
}
