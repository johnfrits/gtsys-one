...
{
    public struct clsMas_InventorySettings
    {
        #region Column
        static string[] Column = {   "operation"
                                    ...
                                    ,"datecreate"
                                    ,"map_sourced_inventory_settings_id"
                                    ,"value"
                                    ,"NewPK"
                                 };
        #endregion
        ...
        public static object[] Value(int m_operation = 0
                                    ...
                                    , string m_datecreate = ""
                                    , int m_map_sourced_inventory_settings_id = 0
                                    , object m_value = null
                                    ...
                                    )
        {
            ...
            s_Value[12] = m_map_sourced_inventory_settings_id;
            s_Value[13] = m_value;
            s_Value[14] = m_NewPK;
            return s_Value;
        }
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasInventorySettings", System.Convert.ToInt32(s_Value[0]), 0);
        }
        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasInventorySettings", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasInventorySettings", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasInventorySettings", 0, 3);
        }
    }
}
