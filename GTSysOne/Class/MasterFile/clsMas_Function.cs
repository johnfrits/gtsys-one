namespace GTSysOne.Class.MasterFile
{
    public struct clsMas_Function
    {
        ...
        public static object[] Value(int m_operation = 0
                                    ...
                                    , string m_datecreate = ""
                                    , string m_map_sourced_module_id = ""
                                    , string m_name = ""
                                    ...
                                    )
        {
            ...
            s_Value[12] = m_map_sourced_module_id;
            s_Value[13] = m_name;
            s_Value[14] = m_NewPK;
            return s_Value;
        }
        ...
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasFunction", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasFunction", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasFunction", 0, 3);
        }
    }
}
