...
{
    public struct clsMas_Establishment
    {
        #region Column
                                    ...
                                    )
        {
            ...
            s_Value[12] = m_doc_sourced_company_id;
            s_Value[13] = m_name;
            s_Value[14] = m_shortname;
            s_Value[15] = m_address;
            s_Value[16] = m_server;
            s_Value[17] = m_control;
            s_Value[18] = m_cpu;
            s_Value[19] = m_virtual;
            s_Value[20] = m_NewPK;
            return s_Value;
        }
        #endregion
        ...
        {
            return (string)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasEstablishment", System.Convert.ToInt32(s_Value[0]), 0);
        }
        public static System.Data.DataTable ShowTable(object[] s_Value)
        {
            return (System.Data.DataTable)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasEstablishment", 0, 1);
        }
        public static object ScalarValue(object[] s_Value)
        {
            return GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasEstablishment", 0, 2);
        }
        public static System.Data.DataSet ShowDataSet(object[] s_Value)
        {
            return (System.Data.DataSet)GTSysOne.Class.Utility.clsUtility.ManagedExecution(Column, s_Value, "sp_MasEstablishment", 0, 3);
        }
    }
}
