...
{
    public partial class frmSalesOrder : GTSysOne.Gui.Main.frmDashboard
    {
        private static string Search;
        private static frmSalesOrder p_instance = null;
        public static frmSalesOrder Instance
        {
            get
            {
                if (p_instance == null) p_instance = new frmSalesOrder();
        ...
        protected frmSalesOrder()
        {
            ...
            ((System.Windows.Forms.ContextMenuStrip)this.contextMenuDashBoard).Items["cmsNew"].Visible = GTSysOne.Class.Utility.clsGlobal.Instance().Allow_To_Add_Sales_Order;
            ((System.Windows.Forms.ContextMenuStrip)this.contextMenuDashBoard).Items["cmsEdit"].Visible = GTSysOne.Class.Utility.clsGlobal.Instance().Allow_To_Edit_Sales_Order;
            ((System.Windows.Forms.ContextMenuStrip)this.contextMenuDashBoard).Items["cmsView"].Visible = GTSysOne.Class.Utility.clsGlobal.Instance().Allow_To_View_Sales_Order;
